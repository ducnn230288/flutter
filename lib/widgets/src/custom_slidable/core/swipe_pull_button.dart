...
class _SwipePullButtonState extends State<SwipePullButton> with TickerProviderStateMixin {
        ...
        child: Align(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.horizontal(right: Radius.circular(action.backgroundRadius)),
                color: action.color,
              ),
  ...
  Widget _buildIcon(SwipeAction action, bool shouldShowNestedActionInfo) {
    return shouldShowNestedActionInfo
        ...
        : SizedBox(width: action.icon != null ? widget.widthIcon : 0, child: action.icon ?? const SizedBox());
  }
