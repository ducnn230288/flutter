...
class _PopUpItem extends StatelessWidget {
  ...
  const _PopUpItem(
      {Key? key, required this.ctx, required this.data, required this.index})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Widget button({required Widget child, required String code}) =>
        GestureDetector(
            ...
            child: Row(
              ...
              children: [
                ...
                line(
                    height: 38,
                    width: 0.5,
                    color: CColor.black.shade300.withOpacity(0.3)),
                button(
                    code: 'EDIT',
                    child: Icon(Icons.edit_square, color: CColor.primary)),
                line(
                    height: 38,
                    width: 0.5,
                    color: CColor.black.shade300.withOpacity(0.3)),
                button(
                    code: 'PASSWORD',
                    child: Icon(Icons.key, color: CColor.warning)),
              ],
            ),
          ),
        ];
        ...
        return PopupMenuButton<MCodeType>(
            shape: ShapeBorder.lerp(
              RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(CSpace.mediumSmall)),
              ...
              switch (item.code) {
                ...
                case 'DELETE':
                  UDialog().showConfirm(
                    ...
                    text:
                        'Thao tác này sẽ làm mất đi dữ liệu của bạn. Bạn có chắc chắn thực hiện?',
                    btnOkOnPress: () async {
                ...
                case 'PASSWORD':
                  context.goNamed(
                    CRoute.createInternalUser,
                    queryParams: {
                      'formType': FormType.password.name,
                      'data': jsonEncode(data)
                    },
                  );
              }
